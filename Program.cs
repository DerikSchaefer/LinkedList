            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case 15:
                        ...
                        break;
                    case 16:
                        Console.Write("Enter the elements at which the cycle has to be");
                        data = Convert.ToInt32(Console.ReadLine());
                        list1.InsertCycle(data);
                        break;
                    case 17:
                        if (list1.HasCycle()) Console.WriteLine("List has a cycle");
                        else Console.WriteLine("List does not have a cycle");
                        break;
                    case 18:
                        list1.RemoveCycle();
                        break;
