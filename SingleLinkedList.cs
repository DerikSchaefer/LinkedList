...
namespace LinkedList
{
    class SingleLinkedList
    {
        ...
        public bool Search(int x)
        {
            ...
            if (p == null)
            {
                Console.WriteLine(x + " not ofund in list");
                return false;
            }
            else
            {
        ...
        public void InsertAfter(int data, int x)
        {
            ...
            if (p == null) Console.WriteLine(x + " not present i the list");
            else
            {
                Node temp = new Node(data);
                temp.link = p.link;
        ...
        public void InsertBefore(int data, int x)
        {
            ...
            while (p.link != null)
            {
                if (p.link.info == x) break;
                p = p.link;
            }
            if (p.link == null) Console.WriteLine(x + " not present in the list");
            else
            {
                temp = new Node(data);
                temp.link = p.link;
        ...
        public void InsertAtPosition(int data, int k)
        {
            ...
            Node p = start;
            for (i = 1; i < k - 1 && p != null; i++) // find reference to k-1 node
            {
                p = p.link;
            }
            if (p == null)
        ...
        public void DeleteNode(int x)
        {
            ...
            if (p.link == null) Console.WriteLine("Element " + x + " not in list");
        ...
        {
            if (listStart == null || listStart.link == null) // if list empty or has only 
                return listStart;
        ...
        {
            if (FindCycle() == null) return false;
            else return true;
        }
        ...
        public void InsertCycle(int x)
        {
            ...
            if (px != null) prev.link = px;
            else Console.WriteLine(x + " not present in list");
        }
    }
}